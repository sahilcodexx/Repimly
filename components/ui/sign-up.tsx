...
export const SignUpPage: React.FC<SignUpPageProps> = ({
  ...
  return (
    <div className="min-h-screen flex flex-col md:flex-row font-geist w-[100dvw]">
      <section className="flex-1 flex items-center justify-center p-8">
        <div className="w-full max-w-md">
          <div className="flex flex-col gap-6">
            <Link href="/" className="animate-element animate-delay-50">
              <Button variant="link" size="sm" className="gap-1 px-0 text-muted-foreground">
                <ArrowLeft size={16} />
                Home
              </Button>
            </Link>
            ...
            <button onClick={onGoogleSignUp} className="animate-element animate-delay-700 w-full flex items-center justify-center gap-3 border border-border rounded-2xl py-4 hover:bg-secondary transition-colors">
                <GoogleIcon />
